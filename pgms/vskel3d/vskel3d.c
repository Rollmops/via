 ...
 *
 * $Id: vskel3d.c 3177 2008-04-01 14:47:24Z karstenm $
 *
 *****************************************************************/

/*! \brief vskel3d - 3D skeletonization

\par Description
3D skeletonization. The input image must be binary.
...
int main (int argc,char *argv[])
{
  ...
  char prg[50];	
  sprintf(prg,"vskel3d V%s", getVersion());
  fprintf (stderr, "%s\n", prg);
